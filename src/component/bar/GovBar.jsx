	...
	render() {
		return (
			<div id="GovBar" className="govbar">
				<a href="//gouvernement.lu" target="_blank" className="govbar-logo" rel="noopener" title="Gouvernement du Grand-Duché de Luxembourg (Nouvelle fenêtre)">
				...
				<ul className="govbar-links">
					<li><a href="https://luxembourg.public.lu" target="_blank" rel="noopener" title="luxembourg.lu - Nouvelle fenêtre" className="govbar-link">luxembourg.lu</a>
					</li>
					<li><a href="https://guichet.public.lu" target="_blank" rel="noopener" title="guichet.lu - Nouvelle fenêtre" className="govbar-link">guichet.lu</a>
					</li>
