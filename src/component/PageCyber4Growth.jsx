...
export default class PageCyber4Growth extends React.Component {
	constructor(props) {
		...
		this.partLaureates = React.createRef();
	...
	render() {
		return (
			<div id={"PageCyber4Growth"} className={"page max-sized-page"}>
				...
				<div className="row">
					<div className="col-md-3 order-1 order-md-2">
						<div className="StrategieNational-shortcut-box">
							...
							<h2 onClick={() => this.partLaureates.current.scrollIntoView({ behavior: "smooth" })}>
								Laureates 2022
							</h2>
				...
				<div className="row">
					<div className="col-md-12">
						<h2 ref={this.partLaureates}>Laureates of 2022</h2>
					</div>
					...
					<div className="col-md-3 order-1 order-md-2">
						<div className="StrategieNational-shortcut-box">
							...
							<h4>
								<a
									href={"#"}
									onClick={() => PageCyber4Growth.copyToClipboard("team@cybersecurity-luxembourg.com")}>
					...
					<div className="col-md-9 order-2 order-md-1">
						...
						<div className="row PageCyber4Growth-images">
						...
						<div className="row row-spaced PageCyber4Growth-program">
							<div className="col-md-4">
							</div>
							...
							<div className="col-md-4 PageCyber4Growth-program-criteria">
								<h4>Target</h4>
							</div>
							<div className="col-md-4">
							...
							<div className="col-md-4 PageCyber4Growth-program-focus">
								<div className="shadow-section blue-shadow-section centered-shadow-section">
