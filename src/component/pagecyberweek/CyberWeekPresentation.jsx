				...
				<div className="row row-spaced">
					...
					<div className="col-md-12 row-spaced">
						<p>
							...
							will be offered the opportunity to be visible and share its
							expertise with its peers, potential partners and customers.
						</p>

						<p>
							The event is intended to involve public and private actors coming
							from Luxembourg, the neighbouring region, Europe and beyond.
						</p>

						<p>
							Full details of the event as well as the programme will be unveiled
							as we go. Keep an eye on
