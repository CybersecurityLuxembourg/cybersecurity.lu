...
export default class PageStrategy extends React.Component {
	...
	render() {
		return (
			<div id="PageStrategy" className={"page max-sized-page"}>
				<div className="row">
				...
				<div className="row">
					...
					<div className="col-md-9">
						<div className="row">
							<div className="col-md-12">
								<img className="PageStrategy-pm-picture" src="/img/portrait-pm.png"/>

								<span className="PageStrategy-quote">
									<p>
									...
									<p>
										...
										Economy, the Luxembourg House of Cybersecurity, the Department of Media,
					...
					<div className="col-md-3">
						<div className="PageStrategy-stat-box">
							<h3>CIRCL&#39;s statistics</h3>

							<Popup
								trigger={<div className="PageStrategy-stat-item">
					...
					<div className="col-md-9">
						...
						<div className="row">
							<Collapsible
								className="col-md-4"
								trigger={
									<div className={"PageStrategy-Collapsible-header"}>
										<h3>Objective I</h3>
								...
								<div className="row PageStrategy-Collapsible-content">
									<div className="col-md-12">
										<p>
											<i>
